...
echo "-- [2/5] core files --"
mkdir -p "$WORK_DIR"
LATEX_REQUIRED=(reportkit.cls reportkit-core.sty themes/reportkit-theme-default.sty reportkit-boxes.sty reportkit-code.sty reportkit-diagrams.sty reportkit-process.sty reportkit-spatial.sty reportkit-structure.sty)
