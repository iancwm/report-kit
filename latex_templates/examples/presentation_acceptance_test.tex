...
contract A3 introduced, not against the paged renderer specifically. The same
\RKLink{https://example.com/reportkit-spec} mechanism reportkit-core.sty already
provides under the paged renderer produces a real link annotation here too.
\end{messageslide}
\end{frame}
