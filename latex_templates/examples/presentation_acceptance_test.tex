...
\setreportkitsubject{Presentation accessibility acceptance}
\setreportkitkeywords{ReportKit, presentation, accessibility}
...
Questions welcome. \href{https://reportkit.example/accessibility}{Read the accessibility notes.}
\end{closingslide}
\end{frame}
